...
1. **[Java collection FAQ summary](src/java/collection/java集合框架基础知识&面试题总结.md)** (must see :+1:)
...
Related reading: [read-write separation & sharding summary of common problems](src/high-performance/读写分离&分库分表.md)
